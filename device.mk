...
# This device is mdpi. Fall back to the hdpi version if the mdpi doesn't exist.
...
PRODUCT_COPY_FILES += \
    ...
    device/bq/maxwell2plus/ramdisk/readahead_list.txt:root/readahead_list.txt
...
PRODUCT_COPY_FILES += \
    ...
    device/bq/maxwell2plus/ramdisk/sbin/readahead:root/sbin/readahead \
...
#    device/bq/maxwell2plus/ramdisk/rk30xxnand_ko.ko.3.0.8+:root/rk30xxnand_ko.ko.3.0.36+
